...
public class upload extends AppCompatActivity {
    ...
    EditText userName, medInfo, dom, doe, batchNo, noOfMedicine;
    Button upload;
    ImageView billIv, medicineIv;
    String user, detail, manDate, expDate, bNo, quantity;
    ...
    public  void upload_data(){
        ...
        med_detail medicine_details = new med_detail(user,detail,manDate,expDate,bNo,quantity, medicineUrl, billUrl);
