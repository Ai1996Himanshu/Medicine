...
public class MedAdapter extends RecyclerView.Adapter<MedAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        med_detail med_detail = med_detailsList.get(position);
        Glide.with(context).load(med_detail.getMedUrl()).into(holder.medImage);
        holder.medName.setText(med_detail.getDetail());
        holder.medQua.setText(med_detail.getQuantity());
    }
